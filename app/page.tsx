    ...
    <div className={`${roboto.className} w-[70%] m-auto`}>
      <div className="flex pt-5 pb-5 justify-center ">
        <div className="mt-8 flex-col">
          <h1 className="text-[3rem] text-center font-semibold">Welcome to Get<span className="text-yellow-400">Placed</span><span className="text-[1.5rem] font-semibold">.ai</span></h1>
          ...
          <div className="flex justify-center">
            <div className="relative group">
              <button className="transition-all duration-200 ease-in-out cursor-pointer  rounded pl-5 pr-5 pt-1 pb-1 hover:bg-yellow-100 border-2 border-yellow-400">Get Placement Ready <i className="fi fi-rr-arrow-small-right relative top-0.5"></i></button>
            </div>
          </div>
